...
pub struct UpcaseAbstractColorStyleTypeBody {
    base: UpcaseAbstractSubStyleType,
    body: UpcaseAbstractColorStyleTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractColorStyleTypeBodyExtension {
    Color(Color),
    ColorMode(ColorMode),
...
pub struct UpcaseBasicLinkTypeBody {
    base: UpcaseAbstractObjectType,
    body: UpcaseBasicLinkTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseBasicLinkTypeBodyExtension {
    Href(Href),
...
pub struct UpcaseAbstractStyleSelectorTypeBody {
    base: UpcaseAbstractObjectType,
    body: UpcaseAbstractStyleSelectorTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractStyleSelectorTypeBodyExtension {
...
pub struct UpcaseAbstractLatLonBoxTypeBody {
    base: UpcaseAbstractObjectType,
    body: UpcaseAbstractLatLonBoxTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractLatLonBoxTypeBodyExtension {
    North(North),
    South(South),
    East(East),
    West(West),
...
pub struct UpcaseAbstractTimePrimitiveTypeBody {
    base: UpcaseAbstractObjectType,
    body: UpcaseAbstractTimePrimitiveTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractTimePrimitiveTypeBodyExtension {
...
pub struct UpcaseAbstractObjectType {
    #[serde(rename = "$value")]
    body: Vec<UpcaseAbstractObjectTypeBody>,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractObjectTypeBody {
...
pub struct UpcaseAbstractGeometryTypeBody {
    base: UpcaseAbstractObjectType,
    body: UpcaseAbstractGeometryTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractGeometryTypeBodyExtension {
...
pub struct UpcaseAbstractFeatureTypeBody {
    base: UpcaseAbstractObjectType,
    body: UpcaseAbstractFeatureTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractFeatureTypeBodyExtension {
    Name(Name),
...
pub struct UpcaseAbstractSubStyleTypeBody {
    base: UpcaseAbstractObjectType,
    body: UpcaseAbstractSubStyleTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractSubStyleTypeBodyExtension {
...
pub struct UpcaseAbstractViewTypeBody {
    base: UpcaseAbstractObjectType,
    body: UpcaseAbstractViewTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractViewTypeBodyExtension {
...
pub struct UpcaseAbstractOverlayTypeBody {
    base: UpcaseAbstractFeatureType,
    body: UpcaseAbstractOverlayTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractOverlayTypeBodyExtension {
    Color(Color),
    DrawOrder(DrawOrder),
...
pub struct UpcaseAbstractContainerTypeBody {
    base: UpcaseAbstractFeatureType,
    body: UpcaseAbstractContainerTypeBodyExtension,
}
#[derive(Serialize, Deserialize, Debug)]
#[serde(rename_all = "camelCase")]
pub enum UpcaseAbstractContainerTypeBodyExtension {
